...
PI0_API struct pi0_result pi0_predict_raw_rgb(struct pi0_context * ctx, const struct pi0_image_view * images,
                                              size_t image_count, const float * state, size_t state_dim,
                                              const char * task);
