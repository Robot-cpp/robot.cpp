...
class FastCodec {
  public:
    static std::unique_ptr<FastCodec> create(FastCodecConfig config, std::vector<std::string> vocab_by_id,
    ...
    static std::unique_ptr<FastCodec> create_compiled(FastCodecConfig config, std::vector<int32_t> token_offsets,
    ...
    bool map_fast_to_vlm(const std::vector<int32_t> & fast_ids, std::vector<int32_t> & vlm_ids,
                         std::string & error) const;
    bool map_vlm_to_fast(const std::vector<int32_t> & vlm_ids, std::vector<int32_t> & fast_ids,
                         std::string & error) const;
    ...
    bool extract_fast_tokens(const std::vector<int32_t> & generated_ids, std::vector<int32_t> & fast_ids,
                             std::string & error) const;

    bool decode_fast_tokens(const std::vector<std::vector<int32_t>> & batch_fast_ids, FastDecodeResult & result,
                            std::string & error) const;
    ...
    bool decode_vlm_action_tokens(const std::vector<std::vector<int32_t>> & batch_vlm_ids, FastDecodeResult & result,
                                  std::string & error) const;
  ...
  private:
    ...
    bool byte_level_decode(const std::vector<int32_t> & fast_ids, std::vector<uint32_t> & codepoints,
                           std::string & error) const;
