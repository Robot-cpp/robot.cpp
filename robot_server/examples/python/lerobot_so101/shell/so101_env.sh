...
export PYTHONPATH="${LEROBOT_SO101_ROOT}:${LEROBOT_SO101_ROOT}/other:${LEROBOT_SO101_ROOT}/other/client:${LEROBOT_SO101_ROOT}/other/camera:${VLA_CPP_ROOT}/robot_server"
