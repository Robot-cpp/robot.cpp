...
def main():
    ...
    fout.add_uint32("smolvla.expert.head_dim", head_dim)
    fout.add_uint32("smolvla.expert.num_attention_heads", num_attention_heads)
    fout.add_uint32("smolvla.expert.num_key_value_heads", num_key_value_heads)
