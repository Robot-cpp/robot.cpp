...
rem Camera config aligns with script\shell\so101_env.sh. Edit CAMERA_TYPE and branch values there and here.

for %%I in ("%~dp0..\..") do set "ROOT=%%~fI"
for %%I in ("%ROOT%\..\..") do set "ROBOT_CPP_ROOT=%%~fI"

set "PYTHONPATH=%ROBOT_CPP_ROOT%;%ROOT%;%ROBOT_CPP_ROOT%\robot_client\python;%ROBOT_CPP_ROOT%\robot_client"
