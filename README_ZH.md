...
* **2025.07.09**：Robot.cpp v0.1.0 发布，提供预编译二进制、性能测试和 SO-101 真机、LIBERO仿真示例
* **2025.05.10**：我们开源了 [**pi0.cpp**](https://github.com/JJJYmmm/pi0.cpp)，作为面向 π0 机器人策略模型轻量化本地推理的早期公开原型。
...
对于特定的一些平台与设定，我们已经预编译了一些`model-server`的二进制文件，可以直接在 [release page](https://github.com/Robot-cpp/robot.cpp/releases/latest) 下载下来直接用。
...
**项目负责人：** Chuyan Xiong（[@lxsy-xcy](https://github.com/lxsy-xcy)）
**通讯作者：** Ruiping Wang（[wangruiping@ict.ac.cn](mailto:wangruiping@ict.ac.cn)）
